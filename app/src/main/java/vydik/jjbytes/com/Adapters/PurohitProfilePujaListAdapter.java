...
import vydik.jjbytes.com.Activities.PurohitProfileView;
 ...
 */
public class PurohitProfilePujaListAdapter extends BaseAdapter {
    Activity activity;
    ...
    public PurohitProfilePujaListAdapter(Activity a, ArrayList<String> pujaNameSubscribed,
                                         ArrayList<String> pujaWithSamagriSubscribed, ArrayList<String> pujaWithoutSamagriSubscribed, ArrayList<String> pujaExpertLevel) {
        activity = a;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View vi = convertView;
        if(convertView == null){
            vi = inflater.inflate(R.layout.purohit_puja_list_design,null);
